...
Alpine.data('products', () => ({
 items: [
    ...
    { id: 2, name: 'Arabika Blend', img: '2.jpg', price: 20000},
    { id: 3, name: 'Primo Passo', img: '3.jpg', price: 20000},
    { id: 4, name: 'Ace Gayu', img: '4.jpg', price: 20000},
    { id: 5, name: 'Sumatra Mandeling', img: '5.jpg', price: 20000},
...
// kirim data ke tombol checkout diklik
...
checkoutButton.addEventListener('click', async function(e){
  ...
  //window.open('http://wa.me/6285124175640?text=' + encodeURIComponent(message));
